...
class FileSystemBrowsingViewByFolderTest {
    ...
    public void readInfoAboutFileByUserIdTest(){
        ...
        FileSystemBrowsingQuery<FolderID> command = new FileSystemBrowsingQuery<>(new AuthToken("1"), folderID);
        FileSystemBrowsingViewByFolder viewByUser = new FileSystemBrowsingViewByFolder(fileStorageInMemory);
