...
export class FileListItemView extends Component {
  ...
  get _markup() {
    ...
    const downloadButton = `<button title="download" type="button" 
                                    class="element-control-button download-element-button">
                            <span class="glyphicon glyphicon-download"></span>
                        </button>`;
    const uploadButton = `<button title="download" type="button" class="element-control-button upload-element-button">
                            <span class="glyphicon glyphicon-upload"></span>
                        </button>`;
    return `<tr>
                    <td class="cell-folder-marker">${parser.getFolderMarker(this._itemType)}</td>
                    <td class="cell-icon"><span class="glyphicon 
                            ${parser.getItemIcon(this._itemType, this._itemMimeType)}"></span></td>
                    <td class="cell-name">${parser.getItemName(this._itemType, this._itemName)}</td>
                    <td class="cell-type">${parser.getItemType(this._itemType, this._itemMimeType)}</td>
                    <td 
